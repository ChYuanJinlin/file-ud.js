...
在 [IFile](file://d:\yjl\file-UD\packages\core\src\types\index.d.ts#L321-L405) 接口中添加了分片上传回显所需的字段：
...
**问题**：回显时，后端不会返回完整的 `File` 对象，但 [IFile](file://d:\yjl\file-UD\packages\core\src\types\index.d.ts#L321-L405) 接口要求必须有 `File` 字段。
...
- [setFiles()](file://d:\yjl\file-UD\packages\core\src\uploader\index.ts#L249-L291) - 回显文件列表
- [retry()](file://d:\yjl\file-UD\packages\core\src\uploader\UploadFile.ts#L301-L385) - 重试/继续上传
- [cancel()](file://d:\yjl\file-UD\packages\core\src\uploader\UploadFile.ts#L187-L205) - 取消上传
- [remove()](file://d:\yjl\file-UD\packages\core\src\uploader\UploadFile.ts#L198-L210) - 移除文件
