...
- [cancelUpload](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts) 只是唤醒了等待中的任务，但没有阻止它们继续执行
...
**问题流程**：
1. 用户点击取消
2. [cancelUpload()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts) 设置 `isPaused = true`
...
在 [uploadChunkManager](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts) 类中添加取消标志：
...
在开始时设置 [isCancelled](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts) 标志：
...
**预期结果**：
- ❌ 无法恢复，因为 [isCancelled](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts) 是永久性的
- ✅ 文件状态保持为 "cancelled"
...
**可以**，但需要重新调用 [startUpload()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts)：
...
**注意**：[startUpload()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts) 会重置所有状态，包括 [isCancelled](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts)。
...
**原因**：
1. 中断当前任务的执行链
2. 触发 [Promise.allSettled](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts) 的 rejected 状态
3. 让上层代码知道任务被取消
...
1. ✅ 添加 [isCancelled](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts) 标志
2. ✅ 修改 [waitForResume()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts)，唤醒后检查取消状态
3. ✅ 修改 [cancelUpload()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts)，设置取消标志
4. ✅ 修改 [uploadWithConcurrency()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts)，循环前检查取消状态
...
- [RETRY_AFTER_CANCEL_FIX.md](./RETRY_AFTER_CANCEL_FIX.md) - 取消后重试状态重置说明
