...
6. ✅ **智能判断**：自动检测 [chunkOptions](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/types/index.ts) 配置，无需手动标记是否为分片上传
...
**关键点**：
- ✅ 系统会自动检测 [chunkOptions](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/types/index.ts) 是否存在
- ✅ 如果存在，自动创建 [uploadChunkManager](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts)
- ❌ **不需要**在 [IFile](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/types/index.ts) 中设置 `isChunkUpload: true`
...
```typescript
import { formatFileSize } from '@file-ud.js/core';
...
const filesToRestore: IFile[] = tasks.map(task => ({
  ...
  status: "UDLoading",
  formatSize: formatFileSize(task.size),
...
- ✅ 系统通过检查 [chunkOptions](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/types/index.ts) 自动判断是否为分片上传
- ✅ 代码更简洁，减少冗余配置
...
**原因**：
1. ✅ 系统已经通过 [chunkOptions](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/types/index.ts) 配置判断是否为分片上传
2. ✅ 如果配置了 [chunkOptions](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/types/index.ts)，系统会自动创建 [uploadChunkManager](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadChunkManager.ts)
3. ❌ 在 [IFile](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/types/index.ts) 中重复声明会导致配置不一致的风险
...
**答**：[reselectAndContinue()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/uploader/UploadFile.ts) 方法会验证文件名和大小：
...
- ✅ **配置灵活**：可根据需求启用/禁用
- ✅ **安全可靠**：浏览器本地存储，跨域隔离
- ✅ **智能判断**：自动检测 [chunkOptions](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/types/index.ts)，无需冗余配置
...
- [saveFileToCache()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/utils/fileCache.ts) - 保存文件到缓存
- [restoreFileFromCache()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/utils/fileCache.ts) - 从缓存恢复文件
- [removeFileFromCache()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/utils/fileCache.ts) - 删除指定缓存
- [clearAllFileCache()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/utils/fileCache.ts) - 清空所有缓存
- [getCacheStats()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/utils/fileCache.ts) - 获取缓存统计
- [cleanExpiredCache()](https://github.com/ChYuanJinlin/file-ud.js/blob/main/packages/core/src/utils/fileCache.ts) - 清理过期缓存
