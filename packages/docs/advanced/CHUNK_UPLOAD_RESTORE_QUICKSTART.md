...
setFiles(files)
  ↓
检测 uploader.config.chunkOptions 存在
  ↓
...
- [CHUNK_UPLOAD_RESTORE_GUIDE.md](./CHUNK_UPLOAD_RESTORE_GUIDE.md) - 详细使用指南
- [SETFILES_GUIDE.md](./SETFILES_GUIDE.md) - setFiles 基础用法
- [CANCEL_FIX.md](./CANCEL_FIX.md) - 取消上传功能说明
- [RETRY_AFTER_CANCEL_FIX.md](./RETRY_AFTER_CANCEL_FIX.md) - 取消后重试说明
